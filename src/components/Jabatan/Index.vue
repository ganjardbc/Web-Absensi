...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            axios.post("http://52.15.191.178:8080/position", payload, { headers: HEADERS }).then(response => {
                this.openPopup()
                this.getData()
            })
        },
        remove(id) {
            ...
            if (a) {
                ...
                axios.delete("http://52.15.191.178:8080/position/" + id, { headers: HEADERS }).then(response => {
                    this.getData()
                })
            }
        }
