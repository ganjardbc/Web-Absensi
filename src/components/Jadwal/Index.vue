...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            axios.get("http://35.193.100.247:10000/schedule", { headers: HEADERS }).then(response => {
        ...
        submit() {
            ...
            axios.post("http://35.193.100.247:10000/schedule", payload, { headers: HEADERS }).then(response => {
                this.openPopup()
                this.getData()
            })
        },
        remove(id) {
            ...
            if (a) {
                ...
                axios.delete("http://35.193.100.247:10000/schedule/" + id, { headers: HEADERS }).then(response => {
                    this.getData()
                })
            }
        },
