...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            axios.post("http://52.15.191.178:8080/room", payload, { headers: HEADERS }).then(response => {
                this.openPopup()
                this.getData()
            })
        },
        remove(id) {
            ...
            if (a) {
                ...
                axios.delete("http://52.15.191.178:8080/room/" + id, { headers: HEADERS }).then(response => {
                    this.getData()
                })
            }
        }
