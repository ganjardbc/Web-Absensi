...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            axios.get("http://35.192.37.30:10000/room", { headers: HEADERS }).then(response => {
        ...
        submit() {
            ...
            axios.post("http://35.192.37.30:10000/room", payload, { headers: HEADERS }).then(response => {
                this.openPopup()
                this.getData()
            })
        },
        remove(id) {
            ...
            if (a) {
                ...
                axios.delete("http://35.192.37.30:10000/room/" + id, { headers: HEADERS }).then(response => {
                    this.getData()
                })
            }
        }
